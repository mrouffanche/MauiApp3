...
namespace MauiApp3.ViewModels
{
    public class BeerViewModel : INotifyPropertyChanged
    {
        ...
        public void AddUserAddedBeers()
        {
            // Ajouter les bières locales à la collection ObservableCollection
            foreach (var beer in BeerStore.UserAddedBeers)
            {
                Beers.Add(beer);
            }
        }
